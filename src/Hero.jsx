    ...
    <main className="relative text-[#F5F5DC]">
      ...
      <section className="relative min-h-screen overflow-hidden border-b border-[#C8A27C]/15">
        ...
        >
          ...
          <motion.div {...fadeUp} className="mx-auto mt-10 w-full max-w-4xl">
            ...
            <p className="mt-5 text-lg font-light leading-relaxed tracking-[0.01em] text-[#F5F5DC]/90 sm:text-[1.55rem]">You deserve the <span className="italic text-[#C8A27C]">best!</span> </p>
          </motion.div>

          <motion.div animate={{ y: [0, 9, 0] }} transition={{ duration: 2.4, repeat: Infinity, ease: "easeInOut" }} className="mt-10">
            <p className="text-[0.66rem] uppercase tracking-[0.52em] text-[#C8A27C]/80">Scroll</p>
            <div className="mx-auto mt-2 h-10 w-px bg-[#C8A27C]/55" />
          </motion.div>
        </motion.div>
      </section>
      ...
      <section className="relative overflow-hidden bg-gradient-to-b from-[#3a221b] to-[#2a1712] px-6 py-20 sm:py-24">
        ...
        <motion.div {...fadeUp} className="mx-auto max-w-4xl text-center">
          ...
          <motion.form initial={{ opacity: 0, y: 16 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: false, amount: 0.3 }} transition={{ duration: 0.8, ease: [0.22, 1, 0.36, 1] }} className="mx-auto mt-12 w-full max-w-3xl">
            <input type="email" placeholder="your@email.com" className="w-full border-b border-[#C8A27C]/45 bg-transparent px-2 pb-5 pt-2 text-2xl text-[#F5F5DC] outline-none placeholder:text-[#F5F5DC]/48" />
            <motion.button
